...
def main():
    ...
    args = ap.parse_args()
    result = {'tool': 'memory_classify', 'dry_run': args.dry_run}
    result.update({'status': 'classified', 'memory_type': 'candidate', 'domain': 'generic', 'sensitivity': 'public', 'risk_level': 'low'})
    if args.report:
