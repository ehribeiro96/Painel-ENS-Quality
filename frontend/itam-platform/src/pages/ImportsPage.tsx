...
import { CheckCircle2, FileUp, RotateCw, Upload, XCircle } from "lucide-react";
  ...
  return (
    <div className="base44-import-page">
      <Base44PageHeader
        ...
        title="Importação"
        description="Fluxo real de upload, preview, staging, mapeamento, validação e aplicação com camada visual Base44 sobre a lógica existente."
        actions={
          <>
